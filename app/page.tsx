    ...
    <main>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Harley Tutors home">
          <Image src="/harley-full-logo.png" width={220} height={154} alt="Harley Tutors" priority />
        </a>
      ...
      <section className="final-cta" id="contact">
        ...
        <Image src="/harley-full-logo.png" width={200} height={140} alt="Harley Tutors" />
      ...
      <footer>
        <div className="footer-brand"><Image src="/harley-full-logo.png" width={150} height={105} alt="Harley Tutors" /></div>
