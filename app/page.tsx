...
const youtube = "https://www.youtube.com/@HarleyTutors";
const tiktok = "https://www.tiktok.com/@harleytutors";
const introVideoId = "AfCmIhA-HrM";
...
const testimonials = [
  ...
  {
    quote:
      "Every lesson had a clear plan. No wasted time, no vague 'how did revision go' chat, just steady progress we could actually see.",
    attribution: "Parent of a KS3 student"
  },
  {
    quote:
      "My son used to freeze up on exam-style questions. Now he talks through his working out loud without being asked.",
    attribution: "Parent of an A-Level student"
  },
  {
    quote:
      "The feedback after every session meant we always knew what to focus on at home, not just what happened in the lesson.",
    attribution: "Parent of a Primary student"
  },
  {
    quote:
      "Further Maths felt impossible until it was broken down properly. I went from dreading the subject to actually enjoying it.",
    attribution: "A-Level Maths student"
  }
];

const platforms = [
  { label: "Instagram", detail: "Follow @harleytutors for updates, tips and behind-the-scenes.", status: "Follow us", href: instagram },
  { label: "YouTube", detail: "Short lesson walkthroughs and quick fixes for common misconceptions.", status: "Subscribe", href: youtube },
  { label: "TikTok", detail: "Quick tips, exam technique and bite-sized explanations.", status: "Follow us", href: tiktok }
];
  ...
  if (label === "YouTube") {
    return (
      <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="1.8">
        ...
        <path d="M10.5 9.2 L15.2 12 L10.5 14.8 Z" fill="currentColor" stroke="none" />
      </svg>
    );
  }
  return (
    <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <path d="M14 3.5c.6 2 2.1 3.3 4.2 3.5v2.6c-1.6-.05-3-.55-4.2-1.4v6.6a5.1 5.1 0 1 1-4.4-5.05v2.7a2.5 2.5 0 1 0 1.9 2.42V3.5Z" strokeLinejoin="round" />
    </svg>
  );
}
    ...
    <main>
      ...
      <section className="section social-section">
        ...
        <div className="social-grid">
            ...
            <div className="video-bubble">
              <div className="video-frame video-embed">
                <div className="video-embed-inner">
                  <iframe
                    src={`https://www.youtube-nocookie.com/embed/${introVideoId}?autoplay=1&mute=1&loop=1&playlist=${introVideoId}&controls=1&rel=0&modestbranding=1`}
                    title="Harley Tutors introduction video"
          ...
          <div className="platform-grid platform-grid-triangle">
            {platforms.map((p, i) => (
              <Reveal delay={i * 80} key={p.label} className={i === 2 ? "platform-slot-bottom" : ""}>
                {p.href ? (
                  <a className="platform-card platform-card-live" href={p.href} target="_blank" rel="noreferrer">
                    <span className="platform-icon"><PlatformIcon label={p.label} /></span>
        ...
        <div className="testimonial-marquee">
          <div className="testimonial-track">
            {[...testimonials, ...testimonials].map((t, i) => (
              <figure className="testimonial-card-sm" key={`${t.attribution}-${i}`}>
                <span className="testimonial-mark-sm">&ldquo;</span>
