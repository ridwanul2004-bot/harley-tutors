...
const subjects = [
  ...
  },
  {
    ...
    tags: ["Primary", "KS3", "GCSE", "A-Level Lang", "A-Level Lit"]
  },
  {
    number: "03",
    title: "Science",
...
const platforms = [
  { label: "YouTube", detail: "Short, focused walkthroughs of the topics students ask about most.", status: "Coming soon" },
  { label: "TikTok", detail: "60-second fixes for the misconceptions that trip up whole classes.", status: "Coming soon" },
  { label: "Instagram", detail: "Follow @harleytutors for updates, tips and behind-the-scenes.", status: "Follow us" },
  { label: "Revision guides", detail: "Condensed, exam-board-aligned notes you can actually revise from.", status: "Coming soon" }
];
...
const founders = [
  {
    ...
    bio: "A Physics graduate and Teach First Mathematics trainee, Ridwan has spent hundreds of hours in classrooms and one-to-one lessons. He built Harley Tutors around a simple rule: no student should leave a lesson more confused about how they're doing than when they arrived.",
    quote:
  ...
  },
  {
    initials: "SH",
    name: "Shafi",
    role: "Tutoring & marketing",
    bio: "Currently training in medicine, Shafi brings a diagnostic instinct to how Harley Tutors teaches: find the actual root of a misunderstanding before treating the symptom of a wrong answer. He shapes how Harley Tutors shows up for every family, from the first message onward.",
    quote:
    ...
    <main>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Harley Tutors home">
          <Image src="/harley-logo.png" width={104} height={104} alt="Harley Tutors feather logo" priority />
        ...
        <div className="hero-visual" aria-label="Illustration of an online maths lesson">
          <div className="lesson-window">
            ...
            <div className="lesson-content">
              ...
              <h2>Maclaurin series for sin(x)</h2>
              <div className="equation equation-small">sin x = x &minus; x&sup3;/3! + x&sup5;/5! &minus; &hellip;</div>
              <div className="working">
                <span>P&#8321;(x) = x</span>
                <span className="gold-text">P&#8325;(x) = x &minus; x&sup3;/6 + x&sup5;/120</span>
              </div>
              <DrawnMaclaurin />
              <div className="lesson-progress"><span /></div>
              <div className="feedback-pill">✓ Approximation converging</div>
            </div>
          </div>
            ...
            {platforms.map((p, i) => (
              <Reveal delay={i * 80} key={p.label}>
                <div className="platform-card">
                  <span className={`status-pill ${p.status === "Coming soon" ? "" : "status-pill-live"}`}>{p.status}</span>
                  <h3>{p.label}</h3>
                  <p>{p.detail}</p>
                </div>
              </Reveal>
      ...
      <section className="final-cta">
        ...
        <Image src="/harley-logo.png" width={110} height={110} alt="" />
      ...
      <footer>
        <div className="footer-brand"><Image src="/harley-logo.png" width={52} height={52} alt="Harley Tutors" /><span>HARLEY TUTORS</span></div>
