...
const platforms = [
  { label: "YouTube", detail: "Short, focused walkthroughs of the topics students ask about most.", status: "Coming soon", href: null },
  { label: "TikTok", detail: "60-second fixes for the misconceptions that trip up whole classes.", status: "Coming soon", href: null },
  ...
  { label: "Revision guides", detail: "Condensed, exam-board-aligned notes you can actually revise from.", status: "Coming soon", href: null }
];
